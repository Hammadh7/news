...
export default function ShareButtons({ url, title }: { url: string; title: string }) {
  ...
  return (
    <div className="flex items-center gap-3">
      <span className="text-xs uppercase tracking-wider text-gray-500 font-sans">Share</span>
      <a
      ...
      <button
        onClick={copyLink}
        className="w-8 h-8 flex items-center justify-center rounded-full border border-gray-300 hover:bg-gray-100 transition-colors relative"
